...
| `headers`                | `ITableHeader<T>`                                                | Object that defines the headers of the table. It includes a label, renderer function for data transformation, and a visibility toggle.                                                 | Required                     |
| `customHeaders`          | `ICustomHeader<T>[]`                                             | Object that defines custom headers for the table for which properties doesn't exit in object. It includes a label, renderer function for data transformation, and a visibility toggle. | Required                     |
...
| `renderer`             | `(value: any) => string`                                                                  | Function to process or format the data for display in the column.                                                       |
